...
function DashHeader({ name }: { name: string }) {
...
function HeroSeance({ layout, onStart }: { layout: string; onStart: () => void }) {
...
function ProgressCards() {
  ...
  const cardStyle = { minWidth: 168, padding: 16, display: 'flex', flexDirection: 'column' as const, gap: 10, flexShrink: 0 };
  return (
...
export function DashboardScreen({ name, heroLayout, onStartWorkout }: { name: string; heroLayout: string; onStartWorkout: () => void }) {
  return (
